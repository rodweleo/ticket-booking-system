...
export const UserAccount = () => {
    ...
    return <main className="flex w-full h-screen fixed">
        <nav id="user-main-nav-bar" className="bg-blue-900/50 w-56 h-screen pl-2 pt-5 flex flex-col justify-between">
            ...
            <ul>
                <li><button className="m-2 w-full font-bold text-2xl bg-red-300 p-2.5 rounded-md text-red-600" onClick={() => handleSignOut()}><i className="fa-solid fa-arrow-right-from-bracket"></i> Sign Out</button></li>
            </ul>
        </nav>
